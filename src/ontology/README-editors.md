These notes are for the EDITORS of PNADO
...
Make sure you have an ID range in the [idranges file](PNADO-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [PNADO-edit.owl](PNADO-edit.owl)

** DO NOT EDIT PNADO.obo OR PNADO.owl in the top level directory **

[../../PNADO.owl](../../PNADO.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/SabrinetteAzzi/PNADO) for details.
 ...
 * [PNADO-idranges.owl](PNADO-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/PNADO_terms.txt file
...
Note: the PNADO_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as PNADO.owl and PNADO.obo and places
 ...
 * https://github.com/SabrinetteAzzi/PNADO/releases
 * https://github.com/SabrinetteAzzi/PNADO/releases/new
...
what is in the `owl:versionIRI` of the derived PNADO.owl (`data-version` in
PNADO.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/PNADO.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/PNADO/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/SabrinetteAzzi/PNADO.svg?branch=master)](https://travis-ci.org/SabrinetteAzzi/PNADO)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/SabrinetteAzzi](https://travis-ci.org/profile/SabrinetteAzzi)
 2. click the "Sync account" button
 3. Click the tick symbol next to PNADO
